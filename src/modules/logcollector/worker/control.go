...
import (
	...
	"github.com/open-falcon/falcon-ng/src/modules/logcollector/reader"
...
func UpdateConfigsLoop() {
	for {
		...
		time.Sleep(time.Second * time.Duration(config.Config.Strategy.UpdateDuration))
	}
}
